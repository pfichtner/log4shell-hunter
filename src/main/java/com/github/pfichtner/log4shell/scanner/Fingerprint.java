...
public class Fingerprint {
	...
	private static Map<String, Set<Class<? extends AbstractDetector>>> mapping() {
		...
		return Map.ofEntries( //
				entry("2.0-alpha1", a), entry("2.0-alpha2", a), entry("2.0-beta1", a), entry("2.0-beta2", a),
				entry("2.0-beta3", a), entry("2.0-beta4", a), entry("2.0-beta5", a), entry("2.0-beta6", a),
				entry("2.0-beta7", a), entry("2.0-beta8", a),
				// ************************************************************************************************
				entry("2.0-beta9", b), entry("2.0-rc1", b),
				// ************************************************************************************************
				entry("2.0-rc2", c), entry("2.0", c), entry("2.0.1", c), entry("2.0.2", c),
				// ************************************************************************************************
				entry("2.1", d), entry("2.2", d), entry("2.3", d), entry("2.4", d), entry("2.4.1", d), entry("2.5", d),
				entry("2.6", d), entry("2.6.1", d), entry("2.6.2", d), entry("2.7", d), entry("2.8", d),
				entry("2.8.1", d), entry("2.8.2", d), entry("2.9.0", d), entry("2.9.1", d), entry("2.10.0", d),
				entry("2.11.0", d), entry("2.11.1", d), entry("2.11.2", d), entry("2.12.0", d), entry("2.12.1", d),
				// ************************************************************************************************
				entry("2.12.2", e),
				// ************************************************************************************************
				entry("2.12.3", f),
				// ************************************************************************************************
				entry("2.13.0", d), entry("2.13.1", d), entry("2.13.2", d), entry("2.13.3", d), entry("2.14.0", d),
				entry("2.14.1", d),
				// ************************************************************************************************
				entry("2.15.0", g),
				// ************************************************************************************************
